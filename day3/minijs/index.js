...
btn2=document.getElementById("hoisting");


btn2.addEventListener("click",readho);
...
btn3=document.getElementById("constructor_functions");

 btn3.addEventListener("click",readcf);
...
appendcons(arr3)
        ...
        btn4=document.getElementById("prototype");

 btn4.addEventListener("click",readpro)
